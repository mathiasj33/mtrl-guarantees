...
def get_ppo_params() -> dict:
    ...
    params = dm_control_suite_params.brax_ppo_config("CheetahRun")
    return dict(params)
...
@hydra.main(version_base="1.1", config_path="../../conf", config_name="cheetah")
def main(cfg: DictConfig):
    """Main training function."""
    logger.info("Starting Cheetah training")

    # Create environment
    logger.info("Creating CheetahRobust environment...")
    env = CheetahRobust()
    # Create task sampler
