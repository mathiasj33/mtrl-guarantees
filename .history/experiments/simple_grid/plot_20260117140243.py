...
def main(cfg: DictConfig):
    ...
    ax0.set_title(
        r"\textbf{Slip Probability Density Function}",
        fontsize=13,
        color=ANTHROPIC["ink"],
        pad=8,
    )
    ...
    ax1.plot(
        ...
        linewidth=2.4,  # thinner (still slightly thicker so it reads)
        linestyle="--",
        dash_capstyle="round",
    ...
    ax1.set_title(
        r"\textbf{Performance Guarantees}",
        fontsize=13,
        color=ANTHROPIC["ink"],
        pad=8,
    )
    ax1.set_xlabel(
        r"\textbf{Performance Guarantee }$t$",
        fontsize=14,
        color=ANTHROPIC["ink"],
        labelpad=6,
    )
    ax1.set_ylabel(
        r"\textbf{Satisfaction Probability }$(1-\delta)$",
        fontsize=14,
        color=ANTHROPIC["ink"],
        labelpad=6,
    )
