...
def main(cfg: DictConfig):
    ...
    spl_computed = UnivariateSpline(guarantees["guarantees"], guarantees["probs"], k=3, s=0.0001)
    x_smooth_computed = np.linspace(guarantees["guarantees"].min(), guarantees["guarantees"].max(), 150)
    y_smooth_computed = spl_computed(x_smooth_computed)
    ...
    spl_actual = UnivariateSpline(actual_guarantees["guarantees"], actual_guarantees["probs"], k=3, s=0.001)
    x_smooth_actual = np.linspace(actual_guarantees["guarantees"].min(), actual_guarantees["guarantees"].max(), 150)
    y_smooth_actual = spl_actual(x_smooth_actual)
