...
def main(cfg: DictConfig):
    ...
    # Apply very light smoothing to red curve while maintaining monotonicity
    ir = IsotonicRegression(y_min=guarantees["probs"].min(), y_max=guarantees["probs"].max())
    y_smoothed_red = ir.fit_transform(guarantees["guarantees"], guarantees["probs"])
