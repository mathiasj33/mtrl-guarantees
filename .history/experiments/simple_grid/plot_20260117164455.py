...
def main(cfg: DictConfig):
    ...
    spl_computed = make_interp_spline(guarantees["guarantees"], guarantees["probs"], k=3)
    x_smooth_computed = np.linspace(guarantees["guarantees"].min(), guarantees["guarantees"].max(), 300)
    ...
    spl_actual = make_interp_spline(actual_guarantees["guarantees"], actual_guarantees["probs"], k=3)
    x_smooth_actual = np.linspace(actual_guarantees["guarantees"].min(), actual_guarantees["guarantees"].max(), 300)
